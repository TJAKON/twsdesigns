      ...
      <Link href="/" className="relative h-full w-full transition-all duration-700 ease-in-out group-hover:w-[30%] hover:w-[70%]">
        <div className="relative h-full w-full group/inner overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center text-center bg-transparent group-hover/inner:bg-white/10 transition-all duration-500 delay-200">
            <h1 className="text-[#683e2a] text-6xl md:text-8xl font-serif tracking-wider leading-tight opacity-0 group-hover/inner:opacity-80 transition-opacity duration-700 delay-300">
              ARCHITECTURE
            </h1>
          </div>
        </div>
